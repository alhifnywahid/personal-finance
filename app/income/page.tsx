...
export default function IncomePage() {
  ...
  const [firstTransactionDate, setFirstTransactionDate] = useState<Date | null>(
    null
  );
  ...
  const addCategory = async (categoryName: string) => {
    if (!user?.uid || !categoryName.trim() || categories.includes(categoryName))
      return;
                      ...
                      <Calendar
                        ...
                        disabled={(date) =>
                          firstTransactionDate
                            ? isBefore(date, firstTransactionDate)
                            : false
                        }
                        modifiers={{
        ...
        <Drawer open={isDeleteDrawerOpen} onOpenChange={setIsDeleteDrawerOpen}>
          <DrawerContent>
            <DrawerHeader>
              ...
              <DrawerDescription>
                Apakah Anda yakin ingin menghapus pemasukan ini? Tindakan ini
